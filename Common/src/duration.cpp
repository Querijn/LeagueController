...
#include <league_controller/duration.hpp>
...
LeagueController::Duration operator""_ns(u64 a_Value) { return LeagueController::Duration::FromNanoseconds(a_Value); }
LeagueController::Duration operator""_us(u64 a_Value) { return LeagueController::Duration::FromMicroseconds(a_Value); }
LeagueController::Duration operator""_ms(u64 a_Value) { return LeagueController::Duration::FromMilliseconds(a_Value); }
LeagueController::Duration operator""_sec(u64 a_Value) { return LeagueController::Duration::FromSeconds(a_Value); }
LeagueController::Duration operator""_min(u64 a_Value) { return LeagueController::Duration::FromMinutes(a_Value); }